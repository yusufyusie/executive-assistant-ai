...
export default (): AppConfig => ({
  ...
  gemini: {
    ...
    requestsPerMinute: parseInt(process.env.GEMINI_REQUESTS_PER_MINUTE, 10) || 15,
  },
  google: {
  ...
  sendgrid: {
    ...
    dailyLimit: parseInt(process.env.EMAIL_DAILY_LIMIT, 10) || 100,
  ...
  security: {
    ...
    jwtExpirationTime: parseInt(process.env.JWT_EXPIRATION_TIME, 10) || 3600,
